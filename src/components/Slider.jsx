...
import { Couple1, Couple2, Friends1 } from "../assets/images";
...
const Slider = () => {
  ...
  return (
    <div className="relative overflow-hidden py-8 w-full max-md:hidden">
      <motion.div
        drag="x"
        dragConstraints={{
          left: 0,
        ...
        return (
          <button
            ...
            className={`h-3 w-3 rounded-full transition-colors cursor-pointer ${
              idx === imgIndex ? "bg-pink-400" : "bg-pink-200"
            }`}
          />
        );
      })}
